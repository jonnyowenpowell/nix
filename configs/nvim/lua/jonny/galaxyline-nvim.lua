local s = require 'jonny.utils'.symbols
...
gl.section.left = {
  ...
  },
  {
    FileIcon = {
      ...
      provider = function ()
        vim.cmd('hi GalaxyFileIcon guifg='..require'galaxyline.providers.fileinfo'.get_file_icon_color()..' guibg='..require'lush_theme.jonny'.StatusLine.bg.hex)
